...
7. 已知向量 $\alpha_1 = \begin{pmatrix} 1 \\ 2 \\ 3 \end{pmatrix}$, $\alpha_2 = \begin{pmatrix} 2 \\ 1 \\ 1 \end{pmatrix}$, $\beta_1 = \begin{pmatrix} 2 \\ 5 \\ 9 \end{pmatrix}$, $\beta_2 = \begin{pmatrix} 1 \\ 0 \\ 1 \end{pmatrix}$, 若 $\gamma$ 既可由 $\alpha_1, \alpha_2$ 线性表示，
